<div id="googleanalytics_terms_notice"
    ...
    <p>
        Google Analytics <?php echo esc_html( GOOGLEANALYTICS_VERSION ); ?> plugin <a
                href="http://kiwi-science.com/"
                target="_blank">has joined the Kiwi-science family.</a>
        <strong>A host of new features</strong> have been added in this version, including Google Analytics dashboards,
        Trending Content, and Alerts. The update requires agreeing to the <a href="http://www.sharethis.com/privacy/" target="_blank">privacy policy</a> and <a
