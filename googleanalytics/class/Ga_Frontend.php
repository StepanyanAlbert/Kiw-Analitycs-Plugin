...
class Ga_Frontend {
	...
	const GA_KIWI_PLATFORM_URL = '//platform-api.sharethis.com/js/sharethis.js';

	public static function platform_sharethis() {
		$url = self::GA_KIWI_PLATFORM_URL . '#product=ga';
		if ( get_option( Ga_Admin::GA_KIWI_PROPERTY_ID ) ) {
			$url = $url . '&property=' . get_option( Ga_Admin::GA_KIWI_PROPERTY_ID );
		}
